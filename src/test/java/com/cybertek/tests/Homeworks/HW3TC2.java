...
public class HW3TC2 {
    ...
    public void test1() throws InterruptedException {
        ...
        WebElement actualResult = driver.findElement(By.xpath("//input[contains(@value,'1')]"));
       // System.out.println(actualResult.getAttribute("value"));

        Assert.assertEquals(actualResult.getAttribute("value"),"1","Verify that page number is equals to 1");
